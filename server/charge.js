...
const MONGO_URI="mongodb+srv://designer:ElonMusk123@designer.ddxxw58.mongodb.net/designer"
console.log("This fff", MONGO_URI)
...
exports.handler = async (req, res) => {
  console.log("this came in", req)
  if (req.httpMethod === 'POST' && req.path === '/charge') {
    try {
      var { items } = req.body;
